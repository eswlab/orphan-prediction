...
To merge `maker-final.gff3` generated by MAKER with direct evidence models `mikado.loci.gff3`, EVM can be used:

```
runEVM.sh maker-final.gff3 mikado.loci.gff3
```
...
```
runEVM.sh braker-final.gff3 mikado.loci.gff3
```
