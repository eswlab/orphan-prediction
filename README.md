...
## MIND final step: merge gene predictions by **M**AKER with gene predictions  **IN**ferred **D**irectly)
...
## BIND final step: merge gene predictions **B**RAKER with gene predictions **IN**ferred **D**irectly)
