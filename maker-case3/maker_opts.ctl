...
augustus_species=case3_ #case3_20170404b #Augustus gene prediction species model
...
single_length=15 #min length required for single exon ESTs if 'single_exon is enabled'
